...
5) [`example_data`](./example_data).
    1) [example_decision.csv](https://github.com/Harry-Nan/IE-administrative-decisions/blob/main/example_data/example_decision.csv). Contains data for a single decision (KSA, administrative fine) used for [Demo.ipynb](https://github.com/Harry-Nan/IE-administrative-decisions/blob/main/demo.ipynb) (which is obtained from [Woogle](https://woogle.wooverheid.nl/search?publisher=zb000182&page=1&country=nl) in April 2024).
    2) [ksa.csv](https://github.com/Harry-Nan/IE-administrative-decisions/blob/main/example_data/KSA.csv). Contains example data for KSA (which is obtained from [Woogle](https://woogle.wooverheid.nl/search?publisher=zb000182&page=1&country=nl) in April 2024 and contains some irrelevant data).
